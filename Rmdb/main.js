...
const renderMovie = async (movie) => {
  ...
  CONTAINER.innerHTML = `
        <div class="flex flex-col col-span-3 space-y-10 lg:space-x-6 lg:space-y-0 lg:flex-row  w-full">
          <div class="relative shrink-0">
            ...
            <div class="absolute -bottom-6 right-1/2 border-2 border-customYellow translate-x-1/2 bg-customBlack py-2 px-7 rounded-full">
              ...
              <i class="fa-solid fa-star mr-2 text-xl text-customYellow"></i>
...
actors_btn?.addEventListener("click", () => {
  getLatestActors();
  actors_btn.style.color = "#deb522";
  aboutUs.style.color = "white";
  home.style.color = "white";
  now_playing.style.color = "white";
  populer.style.color = "white";
  topRated.style.color = "white";
  upCaming.style.color = "white";
  movieDropdown.style.color = "white";
  dropdownDefault.style.color = "white";
});
aboutUs?.addEventListener("click", () => {
  renderAboutUs();
  actors_btn.style.color = "white";
  aboutUs.style.color = "#deb522";
  home.style.color = "white";
  now_playing.style.color = "white";
  populer.style.color = "white";
  topRated.style.color = "white";
...
genre_btn?.addEventListener("click", async (e) => {
  ...
  e.target.color = "#deb522";
  dropdownDefault.style.color = "#deb522";
  actors_btn.style.color = "white";
  aboutUs.style.color = "white";
  home.style.color = "white";
  now_playing.style.color = "white";
...
now_playing?.addEventListener("click", () => {
  ...
  aboutUs.style.color = "white";
  home.style.color = "white";
  now_playing.style.color = "#deb522";
  populer.style.color = "white";
  topRated.style.color = "white";
  upCaming.style.color = "white";
  movieDropdown.style.color = "#deb522";
});
